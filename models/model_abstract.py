...
class ModelAbstract(BaseModel, abc.ABC):
    ...
    def __repr_args__(self) -> Sequence[Tuple[Optional[str], Any]]:
        return [(key, self.__filter_fn(value)) for key, value in super().__repr_args__() if key[0:2] != 'x_']
    ...
    def __filter_fn(self, value):
        ...
        if isinstance(value, list) and len(value) > 0 and isinstance(value[0], ModelAbstract):
